...
import { Eye, EyeOff, Mail, Lock, User, ArrowRight, AlertCircle, Gift } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex lg:flex-1 relative hero-gradient">
        ...
        <div className="relative flex flex-col items-center justify-center w-full p-12">
          <div className="text-center max-w-md">
            <div className="w-16 h-16 rounded-2xl bg-coin/20 flex items-center justify-center mx-auto mb-6">
              <Gift className="w-8 h-8 text-coin" />
            </div>
            <h2 className="text-3xl font-bold text-primary-foreground mb-4">
              Start With 100 Free Coins
            </h2>
            <p className="text-primary-foreground/70 mb-8">
              Sign up today and get a welcome bonus to kickstart your learning journey.
            </p>
      ...
      <div className="flex-1 flex flex-col justify-center px-4 sm:px-6 lg:px-20 xl:px-24">
        <div className="mx-auto w-full max-w-sm">
          ...
          {/* Bonus reminder */}
          <div className="mt-6 p-4 rounded-lg bg-coin/10 border border-coin/20 flex items-center gap-3">
            <Gift className="w-5 h-5 text-coin shrink-0" />
            <p className="text-sm text-foreground">
              You'll receive <span className="font-semibold text-coin">100 free coins</span> upon signup!
            </p>
          </div>
